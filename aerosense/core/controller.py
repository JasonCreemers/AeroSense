...
VALID_SONGS = HAPPY_SONGS + SAD_SONGS + ANGRY_SONGS + SERIOUS_SONGS + OTHER_SONGS + SYSTEM_SOUNDS

SHUFFLE_POOL = HAPPY_SONGS + SAD_SONGS + ANGRY_SONGS + SERIOUS_SONGS + OTHER_SONGS
